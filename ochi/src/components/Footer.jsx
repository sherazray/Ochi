...
const footerData = {
    ...
    locations: [
      { address: '202-1965 W 4th Ave', city: 'Vancouver, Canada' },
      { address: '30 Chukarina St', city: 'Lviv, Ukraine' },
    ],
    menu: [
      { name: 'Home', url: '#' },
      { name: 'Services', url: '#' },
    ...
    email: 'hello@ochi.design',
    copyright: ' ochi design 2024. Legal Terms',
    websiteBy: 'Website by Obys',
  };

  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 py-12 px-10 mt-10">
      <div className="w-1/2 h-full flex flex-col justify-between  font-['Founders_Grotesk_X-Condensed ']">
        <div className=" heading">
          <h1 className=" text-8xl uppercase leading-none font-bold ">Eye-</h1>
          <h1 className=" text-8xl uppercase leading-none font-bold  ">
            Opening
          </h1>
        </div>
        <svg
      ...
      <h1 className="  text-7xl uppercase leading-none font-bold ">Presentations</h1>
      <footer className="bg-zinc-900 text-white  p-10">
      <div className="container mx-auto flex flex-wrap justify-between">
        <div className="w-full md:w-1/4 xl:w-1/4 p-6">
          <h3 className="text-lg font-bold mb-4">S:</h3>
          <ul>
        ...
        <div className="w-full md:w-1/4 xl:w-1/4 p-6">
          <h3 className="text-lg font-bold mb-4">L:</h3>
          <ul>
            {footerData.locations.map((item) => (
              <li key={item.address} className="mb-2">
                <span>
        ...
        <div className="w-full md:w-1/4 xl:w-1/4 p-6">
          <h3 className="text-lg font-bold mb-4">M:</h3>
          <ul>
        ...
        <div className="w-full md:w-1/4 xl:w-1/4 p-6">
          <h3 className="text-lg font-bold mb-4">E:</h3>
          <p>
            <a
      ...
      <div className="container mx-auto text-center mt-2">
        ...
        <p className="text-sm">{footerData.websiteBy}</p>
      </div>
    </footer>
      </div>
    </div>
